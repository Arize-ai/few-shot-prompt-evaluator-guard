...
async def self_check_output(
    ...
    with tracer.start_as_current_span("nemo_guardrails_self_check_output") as span:
        ...
        span.set_attribute("bot_response", bot_response)
        span.set_attribute("user_input", user_input)

        task = Task.SELF_CHECK_OUTPUT
        span.set_attribute("task", task.value)
        ...
        if bot_response:
            ...
            with llm_params(
                ...
                span.set_attribute("temperature", config.lowest_temperature)
            ...
            span.set_attribute("has_output_parser", llm_task_manager.has_output_parser(task))
